...
const Manage = () => {
    ...
    return (
        <>
            <Box sx={{ padding: { xs: "5px", sm: "10px", lg: "20px" }, }}>
                {/* <Box sx={{ display: "flex", flexDirection: "row", justifyContent: "space-between", padding: "10px", width: "100%" }}> */}
                ...
                {jobdata.length ?
                    <Box sx={{ marginTop: "30px", width: { xs: 350, sm: 750, md: "100%" } }}>
